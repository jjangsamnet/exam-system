...
export function useUpdateUserApprovalStatus(options?: useDataConnectMutationOptions<UpdateUserApprovalStatusData, FirebaseError, UpdateUserApprovalStatusVariables>): UseDataConnectMutationResult<UpdateUserApprovalStatusData, UpdateUserApprovalStatusVariables>;
export function useUpdateUserApprovalStatus(dc: DataConnect, options?: useDataConnectMutationOptions<UpdateUserApprovalStatusData, FirebaseError, UpdateUserApprovalStatusVariables>): UseDataConnectMutationResult<UpdateUserApprovalStatusData, UpdateUserApprovalStatusVariables>;
