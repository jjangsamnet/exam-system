import { upsertUserRef, createCategoryRef, updateCategoryRef, deleteCategoryRef, createQuestionRef, updateQuestionRef, deleteQuestionRef, addChoiceRef, updateChoiceRef, deleteChoiceRef, addAnswerRef, updateAnswerRef, createExamRef, updateExamRef, deleteExamRef, addQuestionToExamRef, removeQuestionFromExamRef, startExamRef, submitAnswerRef, submitExamRef, gradeSubjectiveAnswerRef, finalizeExamGradingRef, updateQuestionStatisticsRef, getCurrentUserRef, listAllUsersRef, listCategoriesRef, listQuestionsRef, getQuestionByIdRef, listExamsRef, getExamByIdRef, listMyExamAttemptsRef, getExamAttemptByIdRef, getExamAttemptsByExamRef, getQuestionStatisticsRef, listAvailableExamsRef, connectorConfig } from '../../esm/index.esm.js';
...
export function useSubmitAnswer(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
...
export function useUpdateQuestionStatistics(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
...
export function useGetQuestionStatistics(dcOrVars, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts } = validateReactArgs(connectorConfig, dcOrVars, varsOrOptions, options, true, true);
